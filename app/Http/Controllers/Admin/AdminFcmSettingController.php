...
class AdminFcmSettingController extends Controller
{
    ...
    public function update(Request $request): RedirectResponse
    {
        $request->validate([
            ...
            'chat_message_sound' => 'nullable|boolean',
            'chat_request_sound' => 'nullable|boolean',
            'call_sound'         => 'nullable|boolean',
            'live_stream_sound'  => 'nullable|boolean',
        ...
        $updateData = [
            ...
            'chat_message_sound' => $request->boolean('chat_message_sound', false),
            'chat_request_sound' => $request->boolean('chat_request_sound', true),
            'call_sound'         => $request->boolean('call_sound', true),
            'live_stream_sound'  => $request->boolean('live_stream_sound', true),
