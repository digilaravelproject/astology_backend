...
class NotificationController extends Controller
{
    public function count(Request $request)
    {
        try {
            ...
            return response()->json(['status' => 'error', 'message' => 'Failed to fetch notification count.'], 500);
        }
    }
    ...
    public function list(Request $request)
    {
        try {
            ...
            return response()->json(['status' => 'error', 'message' => 'Failed to fetch notifications.'], 500);
        }
    }
    ...
    public function show(Request $request, $id)
    {
        try {
            ...
            return response()->json(['status' => 'error', 'message' => 'Failed to fetch notification details.'], 500);
        }
    }
