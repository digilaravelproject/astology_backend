...
<head>
    ...
    <title>Privacy Policy - {{ config('app.name', 'Surya Path') }}</title>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="content-card" data-aos="fade-up">
                    ...
                    @else
                        <h1 class="display-5 fw-bold text-center mb-4">Privacy Policy</h1>
                        <p class="lead text-center mb-5 text-muted">Your privacy is sacred. Learn how we secure your data at Surya Path.</p>

                        <div class="dynamic-content">
                            <h4 class="fw-bold mt-4 mb-3" style="color: var(--primary-red);">1. Information Collection</h4>
                            <p class="text-muted">
                            ...
                            <h4 class="fw-bold mt-4 mb-3" style="color: var(--primary-red);">2. Call & Chat Confidentiality</h4>
                            <p class="text-muted">
                            ...
                            <h4 class="fw-bold mt-4 mb-3" style="color: var(--primary-red);">3. Payment Security</h4>
                            <p class="text-muted">
                            ...
                            <h4 class="fw-bold mt-4 mb-3" style="color: var(--primary-red);">4. Cookies & Usage Data</h4>
                            <p class="text-muted">
                            ...
                            <p class="mt-5 text-center fw-bold" style="color: var(--accent-gold);">If you have queries regarding data deletion, contact us at support@suryapath.com</p>
                        </div>
                    @endif
                </div>
            </div>
