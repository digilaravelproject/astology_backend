...
<head>
    ...
    <title>Terms & Conditions - {{ config('app.name', 'Surya Path') }}</title>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="content-card" data-aos="fade-up">
                    ...
                    @else
                        <h1 class="display-5 fw-bold text-center mb-4">Terms & Conditions</h1>
                        <p class="lead text-center mb-5 text-muted">Please read the terms of service governing consultation usage at Surya Path.</p>

                        <div class="dynamic-content">
                            <h4 class="fw-bold mt-4 mb-3" style="color: var(--primary-red);">1. Nature of Advisory</h4>
                            <p class="text-muted">
                            ...
                            <h4 class="fw-bold mt-4 mb-3" style="color: var(--primary-red);">2. Billing & Wallet Debit</h4>
                            <p class="text-muted">
                            ...
                            <h4 class="fw-bold mt-4 mb-3" style="color: var(--primary-red);">3. Refund Policy</h4>
                            <p class="text-muted">
                            ...
                            <h4 class="fw-bold mt-4 mb-3" style="color: var(--primary-red);">4. Astrologer Conduct</h4>
                            <p class="text-muted">
                            ...
                            <p class="mt-5 text-center fw-bold" style="color: var(--accent-gold);">For inquiries regarding platform policies, contact us at legal@suryapath.com</p>
                        </div>
                    @endif
                </div>
            </div>
