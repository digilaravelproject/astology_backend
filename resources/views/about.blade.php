...
<head>
    ...
    <title>About Us - {{ config('app.name', 'Surya Path') }}</title>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="content-card" data-aos="fade-up">
                    ...
                    @else
                        <h1 class="display-5 fw-bold text-center mb-4">About Surya Path</h1>
                        <p class="lead text-center mb-5 text-muted">Guiding your life path through solar wisdom and verified celestial consultations.</p>

                        <div class="row g-4 align-items-center mb-5">
                            <div class="col-md-6">
                                <h3 class="fw-bold mb-3">Our Sacred Journey</h3>
                            ...
                            <div class="col-md-6 text-center">
                                <div class="p-4 rounded border" style="background: #fff8e1; border-color: #ffe082 !important;">
                                    <h5 class="fw-bold mb-3" style="color: #b08d00;"><i class="fas fa-sun me-2"></i> Why Surya Path?</h5>
                                    <ul class="list-unstyled text-start text-dark mx-auto" style="max-width: 320px; line-height: 1.8;">
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i> 100% Secure Consultations</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i> Verified Expert Panelists</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i> Real-time Call & Chat 24/7</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i> Rigorous 5-Stage Vetting Process</li>
                                    </ul>
                                </div>
                            </div>
                        </div>

                        <h3 class="fw-bold mb-3">Our Core Values</h3>
                        <div class="row g-4">
                            <div class="col-md-4">
                                <div class="p-3 border rounded h-100 bg-light">
                                    <h6 class="fw-bold" style="color: var(--primary-red);"><i class="fas fa-scroll me-2"></i> Authenticity</h6>
                                    <p class="text-muted small mb-0">Every astrologer undergoes strict reviews and interviews before onboarding.</p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="p-3 border rounded h-100 bg-light">
                                    <h6 class="fw-bold" style="color: var(--primary-red);"><i class="fas fa-lock me-2"></i> Privacy</h6>
                                    <p class="text-muted small mb-0">End-to-end encryption secures your personal chat history and contact information.</p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="p-3 border rounded h-100 bg-light">
                                    <h6 class="fw-bold" style="color: var(--primary-red);"><i class="fas fa-hand-holding-heart me-2"></i> Empathy</h6>
                                    <p class="text-muted small mb-0">Our panel is trained to address client struggles with maximum sensitivity and respect.</p>
                                </div>
                            </div>
                        </div>
                    @endif
