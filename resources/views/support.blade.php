...
<head>
    ...
    <title>Customer Support - {{ config('app.name', 'Surya Path') }}</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{ route('support') }}">Contact Us</a></li>
                </ul>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="content-card" data-aos="fade-up">
                    <h1 class="display-5 fw-bold text-center mb-4">Help & Support</h1>
                    <p class="lead text-center mb-5 text-muted">Have queries or facing an issue? Send us a message and we'll reply shortly.</p>

                    <div class="row g-4 justify-content-center">
                        <div class="col-md-8 col-lg-6">
                            <div class="p-4 rounded border h-100 bg-light" style="border-color: #eaeaea !important;">
                                <h4 class="mb-4 text-center" style="color: var(--primary-red);">{{ $page->title ?? 'Contact Details' }}</h4>
                                
                                @if(isset($page) && $page->content)
                                    <div class="text-dark leading-relaxed" style="white-space: pre-line; font-size: 1.05rem;">
                                        {!! $page->content !!}
                                    </div>
                                @else
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="fs-2 text-danger me-3"><i class="fas fa-envelope"></i></div>
                                        <div>
                                            <h6 class="fw-bold mb-0">Email Support</h6>
                                            <p class="text-muted small mb-0">support@suryapath.com</p>
                                        </div>
                                    </div>
                                    
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="fs-2 text-success me-3"><i class="fab fa-whatsapp"></i></div>
                                        <div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h6 class="fw-bold mb-0">Operation Hours</h6>
                                            <p class="text-muted small mb-0">Mon - Sun (24/7 Hours Support)</p>
                                        </div>
                                    </div>
                                @endif
                            </div>
